...
private:
    ...
    void drawApp();
    void drawOverlays();
    void drawOverlayIndex(uint8_t index);
    void drawIndicators();
    ...
    /* indicators */
    uint32_t m_ind1Color = AwtrixColors::kIndicator1Default,
             m_ind2Color = AwtrixColors::kIndicator2Default,
             m_ind3Color = AwtrixColors::kIndicator3Default;
