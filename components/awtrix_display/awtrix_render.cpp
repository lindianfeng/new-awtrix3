...
constexpr AwtrixRenderLayerInfo kLayers[] = {
    ...
    {AwtrixRenderLayer::Notification,   "Notification",   40, mode_bit(AwtrixDisplayMode::Notification) | mode_bit(AwtrixDisplayMode::Normal)},
    ...
    {AwtrixRenderLayer::SystemStatus,   "SystemStatus",   80, kNormalModes | mode_bit(AwtrixDisplayMode::Moodlight) | mode_bit(AwtrixDisplayMode::ArtNet)},
};
}
