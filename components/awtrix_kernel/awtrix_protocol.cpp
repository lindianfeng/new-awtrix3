...
static bool validate_number_range(cJSON* root, const char* key, double minValue, double maxValue,
...
bool awtrix_protocol_parse_mqtt(const char* topic, const char* payload, AwtrixCommand& out, AwtrixProtocolError& err)
{
    ...
    if (strcmp(topic, "notify") == 0)
    {
        out.type = AwtrixCommandType::Notify;
        return true;
    }
    if (strcmp(topic, "notify/dismiss") == 0)
    {
        out.type = AwtrixCommandType::DismissNotify;
        return true;
    }
    if (strcmp(topic, "apps") == 0)
    {
        out.type = AwtrixCommandType::UpdateApps;
        return true;
    }
    if (strcmp(topic, "switch") == 0)
    {
        out.type = AwtrixCommandType::SwitchApp;
        return true;
    }
    if (strcmp(topic, "settings") == 0)
    {
        out.type = AwtrixCommandType::Settings;
        return true;
    }
    if (strcmp(topic, "nextapp") == 0)
    {
        out.type = AwtrixCommandType::NextApp;
        return true;
    }
    if (strcmp(topic, "previousapp") == 0)
    {
        out.type = AwtrixCommandType::PreviousApp;
        return true;
    }
    if (strcmp(topic, "power") == 0)
    {
        out.type = AwtrixCommandType::Power;
        return true;
    }
    if (strcmp(topic, "sleep") == 0)
    {
        out.type = AwtrixCommandType::Sleep;
        return true;
    }
    if (strcmp(topic, "moodlight") == 0)
    {
        out.type = AwtrixCommandType::Moodlight;
        return true;
    }
    if (strcmp(topic, "sound") == 0)
    {
        out.type = AwtrixCommandType::Sound;
        return true;
    }
    if (strcmp(topic, "r2d2") == 0)
    {
        out.type = AwtrixCommandType::R2D2;
        return true;
    }
    if (strcmp(topic, "rtttl") == 0)
    {
        out.type = AwtrixCommandType::Rtttl;
        return true;
    }
    if (strcmp(topic, "reboot") == 0)
    {
        out.type = AwtrixCommandType::Reboot;
        return true;
    }
