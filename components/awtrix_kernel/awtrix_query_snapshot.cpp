...
extern "C" const char* awtrix_core_query_apps_json(void) __attribute__
((weak));
extern "C" const char* awtrix_core_query_settings_json(void) __attribute__
((weak));
extern "C" const char* awtrix_core_query_stats_json(void) __attribute__
((weak));
extern "C" const char* awtrix_core_query_apps_with_icon_json(void) __attribute__
((weak));
extern "C" const char* awtrix_core_query_effect_names_json(void) __attribute__
((weak));
extern "C" const char* awtrix_core_query_transition_names_json(void) __attribute__
((weak));
