...
static void onButton(int idx, btn_event_t evt)
{
    ...
    if (awtrix_menu_active())
    {
        if (evt == BTN_EVENT_PRESSED)
        {
            switch (idx)
            {
            case BTN_LEFT: awtrix_menu_left();
                break;
            case BTN_RIGHT: awtrix_menu_right();
                break;
            case BTN_SELECT: awtrix_menu_select_short();
                break;
            default: break;
            }
        }
    ...
    if (evt == BTN_EVENT_PRESSED)
    {
        switch (idx)
        {
        case BTN_LEFT: DisplayManager::get().leftButton();
            break;
        case BTN_RIGHT: DisplayManager::get().rightButton();
            break;
        case BTN_SELECT: DisplayManager::get().selectButton();
            break;
        default: break;
        }
    }
